...
public final class ModBlocks{
	...
	public static final RegistryObject<Block> AQUAMARINE_ORE = REGISTER.register("aquamarine_ore", () -> new AquamarineOreBlock(Properties.copy(Blocks.IRON_ORE)));
	public static final RegistryObject<Block> DEEPSLATE_AQUAMARINE_ORE = REGISTER.register("deepslate_aquamarine_ore", () -> new AquamarineOreBlock(Properties.copy(Blocks.DEEPSLATE_IRON_ORE)));
